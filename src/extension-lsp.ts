...
function registerCustomFeatures(context: vscode.ExtensionContext) {
...
function getTopologyVisualizationHtml(): string {
    return `<!DOCTYPE html>
    <html>
    <head>
        <style>
